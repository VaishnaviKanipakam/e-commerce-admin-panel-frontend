...
const Signup = () => {
    ...
    const renderNameField = () => {
        return(
            <div>
                <label htmlFor='name' className='signup-lable'>Name</label>
                <br />
                <input 
                    id='name'
                    value={name}
    ...
    const renderMobileNumberField = () => {
        return(
            <div>
                <label htmlFor='mobileNumber' className='signup-lable'>Mobile Number</label>
                <br />
                <input 
                    id='mobileNumber'
                    value={mobileNumber}
    ...
    const renderEmailField = () => {
        return(
            <div>
                <label htmlFor='email' className='signup-lable'>Email</label>
                <br />
                <input 
                    id='email'
                    value={email}
    ...
    const renderPasswordField = () => {
        return(
            <div>
                <label htmlFor='mobipasswordleNumber' className='signup-lable'>Password</label>
                <br />
                <input 
                    id='password'
                    value={password}
  ...
  return (
    <form className='signum-form' onSubmit={onSubmitSignupForm}>
        ...
        <div>
        <Button variant="contained" type="submit" sx={{marginTop: "20px", backgroundColor: "blue"}}> 
            Signup
        </Button>
        </div>
